...
def generate_brand_snippet(prompt: str):
    ...
    e_prompt = f"Generate upbeat branding snippet for {prompt}"

    response = openai.Completion.create(engine='davinci-instruct-beta-v3', prompt=e_prompt, max_tokens=32)
